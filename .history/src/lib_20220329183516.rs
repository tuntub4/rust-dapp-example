...
//In rust, the struct and its data fields are defined first, and methods are implemented later
#[near_bindgen]
#[derive(BorshDeserialize, BorshSerialize)] //Need serialization explanation
