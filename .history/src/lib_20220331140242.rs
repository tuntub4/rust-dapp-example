...
pub struct StatusMessage { //In Rust, the struct and its data fields are defined first, and methods are implemented later
    records: LookupMap<String, String>, //map 
}
...
impl StatusMessage {
    pub fn set_status(&mut self, message: String) {
        ...
        self.records.insert(&account_id, &message); //passing references to LookupMap::insert(String, String)
...
#[cfg(not(target_arch = "wasm32"))] //conditional compilatioin flags used to specify testing
#[cfg(test)]
mod tests {
    use super::*;
